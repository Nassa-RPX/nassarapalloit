...
// const strokeColor = "#faa61a";
const strokeColor = "#017dc7";
const backgroundColor = "#f1f3f5";
...
const pathVariants: Variants = {
  ...
  animate: {
    ...
    transition: {
      ...
      fill: { ease: "easeInOut", delay: 1.2, duration: 0.5 },
    },
  },
};
...
export const Nassa = () => {
  return (
    <>
      ...
      >
        <motion.path
          style={{ stroke: strokeColor, strokeWidth: "1px" }}
